...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "NamiPairingFramework", url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.8.3/NamiPairingFramework.xcframework.zip",
            checksum: "f09afc66abbdb499981c3b3117a338bdeab3741fd5e74c1ce65351059da60732"),
        .binaryTarget(name: "StandardPairingUI", url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.8.3/StandardPairingUI.xcframework.zip",
