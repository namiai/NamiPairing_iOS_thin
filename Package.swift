...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.7.2/NamiPairingFramework.xcframework.zip",
            checksum: "6f85ae4b2cee23c5dce841d87c49ae2bb9e3c24ed466a8feebf9e87000ec2461"),
        .binaryTarget(
            name: "StandardPairingUI", url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.7.2/StandardPairingUI.xcframework.zip",
