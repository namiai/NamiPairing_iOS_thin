...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.5.0/NamiPairingFramework.xcframework.zip",
            checksum: "645dbf3e5a439672cba3585276703b7739155f292aac2a98ed9ca4225e7252ae"),
        .binaryTarget(
            name: "StandardPairingUI", url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.5.0/StandardPairingUI.xcframework.zip",
