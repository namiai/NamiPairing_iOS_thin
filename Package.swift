...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.4.3/NamiPairingFramework.xcframework.zip",
            checksum: "2bc58b9b23fe8a5fcaa0d3c900122cfd6f4996730dbdfd3229c3f844c98fcbdb"),
        .binaryTarget(
            name: "StandardPairingUI", url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.4.3/StandardPairingUI.xcframework.zip",
