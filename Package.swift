...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.4.2/NamiPairingFramework.xcframework.zip",
            checksum: "510c2a784bea56d1c74dd5fad51915df1ff4ba9f571813b271a0f046cc42aa67"),
        .binaryTarget(
            name: "StandardPairingUI", url: "https://github.com/namiai/NamiPairing_iOS_thin/releases/download/4.4.2/StandardPairingUI.xcframework.zip",
